...
module.exports = {
  ...
  */
  ...
  css: [
    ...
    { src: '~/assets/scss/screen.css', lang: 'css' },
    { src: '~/assets/scss/print.css', lang: 'css' },
    { src: '~/assets/scss/ie.css', lang: 'css' }
  ],
  ...
  */
  styleResources: {
    ...
    scss: './assets/scss/print.css',
    scss: './assets/scss/screen.css',
    sass: './assets/scss/print.sass',
    sass: './assets/scss/screen.sass',
  },
